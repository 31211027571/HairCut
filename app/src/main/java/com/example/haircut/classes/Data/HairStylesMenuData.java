package com.example.haircut.classes.Data;

import com.example.haircut.R;

public class HairStylesMenuData
{
    public static String[] hairStyleArray = {"Cắt tóc dài","\n" +
            "Cắt tóc ngắn","Cạo râu","Cạo râu + Massage","\n" +
            "Duỗi tóc"};
    public static String[] priceArray = {"70.000Đ" , "50.000Đ", "30.000Đ", "38.000Đ", "450.000Đ"};
